...
#reloadfunction
        ...
        # self.root.destroy()
        def vider(): 
            op=messagebox.askyesno("imprimer","tu veux vider les chaises du buss",parent=root)
            if op==True:            
                try:
                    con=connects()
                    cur=con.cursor()
        ...
        btn1=customtkinter.CTkButton(master=self.root,command=vider,text="vider bus",text_font=(15),width=scr_width/8, height=scr_height/18,text_color="black", compound="right",hover_color="dimgray",fg_color="darkkhaki")
